...
public class MathUtilDDTTest {
    ...
    //tên hàm ko quan trọng, quan trọng là chữ @
    ...
    //giả sử loop qua từng dòng của mảng rồi, ta vẫn cần gán từng calue của cột
    //vào biến tương ứng: input/expected để lát hồi feed cho hàm
    
    @Parameterized.Parameter(value = 0)  //value = 0 nghĩa là map với mảng data
    public int n; //biến map với value
